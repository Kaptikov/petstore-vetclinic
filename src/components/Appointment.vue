...
<style lang="scss">
.appointment {
	margin: clamp(70px, 2.169rem + 9.8vw, 110px) 0;
	...
	&__wrapper {
		...
		padding-top: clamp(2.5rem, -0.672rem + 6.61vw, 4.375rem);
		padding-bottom: 60px;
		z-index: 2;
	}
	...
	&__description {
		...
		font-size: 16px;
		line-height: 140%;
		margin-bottom: clamp(40px, -24.457rem + 43.48vw, 140px);
		color: $white;
	}
	...
	&__img-dog {
		...
		margin-top: auto;
		margin-left: auto;
		margin-right: clamp(2.438rem, -24.519rem + 43.48vw, 8.688rem);
		margin-bottom: auto;
		padding-bottom: 38.087%;
		z-index: 1;
	...
	&__img-sheet {
		position: absolute;
		bottom: -31px;
		right: clamp(-4.25rem, -13.34rem + 14.6vw, -2.188rem);
		// max-width: 250px;
		width: 22.889%;
		padding-bottom: 22.567%;

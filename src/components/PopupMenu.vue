  ...
  <transition name=" popup-fade">
    <div class="header__popup-menu header-popup" v-if="isOpen">
      <div class="header-popup__content">
        <h4 class="header-popup__title">Запись на груминг</h4>
        ...
        <form class="header-popup__form">
          <div class="header-popup__item">
            ...
            <input class="header-popup__input" type="text" id="name" required />

            <label class="header-popup__label" for="phone">Телефон*</label>
            <input class="header-popup__input" type="tel" id="phone" placeholder="+7 (___) ___-__-__" required />
          </div>
          <button class="header-popup__btn header-popup__btn--save" type="submit">Оставить заявку</button>

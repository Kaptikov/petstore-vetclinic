<template>
  ...
  <main class="page admin-page">
    <div class="admin-page__container _container">
      <template v-if="isLoggedIn">
        <div class="admin-page__wrapper" v-if="userStore.user && userStore.user.id">
      ...
      <template v-else>
        <!-- <h3 class=" admin-page__title">Войдите в систему</h3>
        <router-link to="/login/" class="admin-page__link">Вход</router-link> -->
      </template>
    </div>
  </main>
  <Footer />
